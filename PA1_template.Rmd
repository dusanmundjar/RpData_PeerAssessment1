...
#### A1.2. Histogram of the total number of steps taken each day
...
### A2.1. Time series plot (i.e. type = "l") of the 5-minute interval (x-axis) and the average number of steps taken, averaged across all days (y-axis)
